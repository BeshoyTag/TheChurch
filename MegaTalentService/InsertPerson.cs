...
int Record_Id;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox1.Text == string.Empty)
            {
                ...
                errorProvider2.SetError(textBox1, "برجاء ادخ" + "ال الاسم");
            }
              ...
              //  else if (textBox13.Text == string.)
                ...
                errorProvider4.SetError(textBox13, "برجاء ادخال الرقم القومي");
            ...
            else if (textBox7.Text == string.Empty)
            {
                ...
                errorProvider3.SetError(textBox7, "برجاء ادخال البحث");
            ...
            //if (textBox1.Text == "")
            //{
            //    errorProvider1.SetError(textBox1, "برجاء ادخال الاسم"); 
            //}
            //else
            //{
